...
export default function Sidebar() {
  ...
  const filteredNav = docsConfig.navigation.filter(item =>
  ...
  return (
    <aside className="fixed left-0 top-0 w-72 h-screen bg-[#f8f9fa] border-r border-[#e0e0e0] overflow-y-auto">
      ...
      <div className="p-4">
        <div className="relative">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-2 text-sm border border-[#e0e0e0] rounded-lg focus:outline-none focus:border-[#1565c0] focus:ring-1 focus:ring-[#1565c0] bg-white"
          />
        </div>
      </div>
      ...
      <div className="absolute bottom-0 left-0 right-0 p-4 border-t border-[#e0e0e0] bg-[#f8f9fa]">
